# -*- terraform -*-
#
# The machine is the front end of the cluster.
#
terraform {
  required_providers {
    openstack = {
...
resource "openstack_compute_instance_v2" "hq3_server" {
...
resource "openstack_compute_floatingip_associate_v2" "fip_1" {
  ...
  instance_id = openstack_compute_instance_v2.hq3_server.id
}
...
#   depends_on = [  openstack_compute_instance_v2.hq3_server ]
...
#     user             = "ubuntu"
#     private_key      = file("../z03.pem")
#     host             = openstack_compute_instance_v2.hq3_server.network[0].fixed_ip_v4
#     bastion_user     = "centos"
#     bastion_host     = var.bastion_ip
#   }
# }
